...
title: "桃華楽堂",
body: "桃華楽堂 桃華楽堂 皇太后良子(ながこ)の還暦を記念して造られた八角形の建物で各面はタイルで優雅な絵が描かれている。音書効果が素晴らしいようだが一般人が使うことは許されていない。 屋根はキンポウゲ科の「テッセン」の花弁（八弁花）を形どっている。 Tokagakudo music hall This building was built in commemoration of the ex-Empress’s 61st birthday in 1963. (This building was the birthday present for the ex-Empress.) It is octagonal and the acoustics are excellent. Each face has an elegant picture of tiles. It has the flower-shaped roof. If you could see the roof from the sky, it would look like　a flower. Tips 「桃華」の由来は、香淳皇后さまの御誕生日が三月なので桃の節句にちなんで桃とし、華の字形は十が六個と一で構成されていることから還暦（数え年61歳）を意味するということで命名された。 外壁のモザイク・タイルの図柄は、各面とも大きく羽ばたく鳥を抽象的に描いたものに、日月星・衣食住・風水火・春夏秋冬・鶴亀・雪月花・楽の音・松竹梅を施したもの。 楽部庁舎 この先に、ベージュ色の建物があります。これは宮内庁の内部組織である楽部の庁舎です。雅楽の保存や演奏演舞を担当する部署です。毎年秋には、楽部による雅楽の一般公開が行われています。通常は一般の人は入れません。 ここはただの事務所なので、あまり説明しなくても良いかも。 This is a office for workers. They are preserving Japanese traditional musics."
},
{

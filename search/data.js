...
title: "本堂",
body: "本堂 本堂 942年に元々の浅草寺は建立された。その後、関東大震災をも無事に免れ世間の話題となったが、 東京大空襲で「国宝浅草寺本堂」は焼け落ちてしまった。現在のものは1958年に建てられたものである。 戦争の歴史はタブーであることも多いので、下にある英語の内容だけ伝えられればバッチリです！ 外陣と内陣に分かれ、大扉の開いている昼間は内陣まで入れる。内陣中央にご本尊聖観世音菩薩像を安置する宮殿がある。三方扉となっていてそれは日本最大の大きさである。本尊は参拝することはできないが、本尊の前の間の「お前立ち」の本尊は33年ごとの開帳、慶祝や記念行事のときに臨時開帳が行われる。本堂では毎朝午前6時(夏)、6時30分(冬)に一日の行事が始まる。 Main Hall The original main hall seemed to be built in 942. But it was burnt many times. In 1958, today’s main hall was rebuilt. Inside the hall, beyond the curtain, the statue of the Goddess of Mercy called Kannon is placed, but we are not permitted to see it. 注意 お寺では、参拝方法が神社と違い一礼のみです。もし一緒にやることになったら気をつけましょう。 また、宗教上の理由から参拝したくない外国人の方もいます。例えばイスラム教では偶像崇拝が禁止されており、ご本尊に手を合わせる行為は基本的にはやってはいけない行為です。 軽く上記の説明をした後、 You can make a wish here. Would you like to try it? と聞き、もし難色を示したら 速やかに出ましょう。 天井の絵 本堂の天井には天女と龍の絵が描かれています。気づきにくいので教えてあげると喜ばれる事が多い。これは本堂を建て直した際に描かれたもの。"
},
{

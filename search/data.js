...
title: "南参道鳥居",
body: "南参道鳥居 \r\r\r明治神宮に原宿駅方面から向かった時、一番初めに遭遇する鳥居。別名「第一の鳥居」。ここがガイドの集合場所になる。 また本殿まで鳥居がいくつかあるが、これは奥に行くにつれて敷居が高くなるのを表している。"
},
{
url: "https://wress.github.io/guide-materials/print/info/",
title: "基本情報 - 印刷用ページ",
body: "基本情報 - 印刷用ページ"
},
{
...
title: "雷門",
body: "雷門 雷門 正式名称は「風神雷神門」という。門に向かって右側に、袋を持った風神、左側に太鼓を持った雷神がいる。五穀豊穣により、平和な世界になることを願ってつくられた。 高さは約12m、現在の門は1960年に松下幸之助によってつくられた。 This outer gate of Senso-ji Temple is called Kaminari-mon. You can see two statues of God: on your right hand the God of Wind is placed, and on your left hand the God of Thunder is placed. The God of Wind has a sack to blow wind, and the God of Thunder has drums to make thunderclap. People believed that those two Gods were protecting this temple from evil spirits and would bring appropriate amount of wind and rain enough to get many crops. 阿吽 風神と雷神、実は風神が「あ」雷神が「うん」の口をしている。 これは、インドで使われていた言語である、サンスクリット語の最初が「あ」、最後が「ん」であることに由来しており、生と死を表していると言われている。門の両サイドに生と死を表す仏像をおくことで、生と死の間にいる「生き物」にしか通れないようにしていると言われてる。つまり、死神や魔物から参道と本堂を守っている。 英語で説明する場合、「あ」と「うん」ではなく、A と Z で説明すると、外国の方もイメージしやすいかと思います。ただ、入り口なので大混雑ですし、苦労の割に伝わらないので、だいたい割愛します。 もしくは、 Facial expression of the God of Wind represents the birth, and that of the God of Thunder represents the death. It means only living things are allowed to pass through the gap between these two statues, and prevents evil spirits from coming inside. 程度で良いでしょう。 提灯 1865年に焼失したものを、1960年にPanasonicの創業者、松下幸之助が寄贈。そのため提灯の下部には「松下電器」の名前が書かれている。 最初は、942年に平公雅によって作られた。五穀豊穣、天下泰平の願いがこめられている。 川柳には「雷門風神様は居候」と詠まれていた。正しくは「風雷神門」ですが、江戸時代、風も雷も鳴ることから「神が鳴る門」ということで、「雷門」と江戸っ子の間で呼ばれるようになったそう。 This original lantern was built more than 1,000 years ago. Though burned at least twice, it was rebuilt by the founder of Matsushita electronics. 約10年ごとに和紙を張り替えて新調しているそう。門の裏には「天竜」と、「金竜」の二体の像が安置されている。 The lantern is renewed every 10 years by re-covering washi (Japanese paper on the surface). この提灯の下を覗くと、竜の彫刻を見ることができる。これは、最初の雷門が火災によって焼失したため、水の神である竜が火災から門を守ってくれるようにという願いが込められている。 竜の彫刻の写真を撮りたいようなら、インカメを使うように勧めると喜ばれます (提灯の下で指をさしながら) You can see a dragon here. The dragon represents the God of Water. In old days, this temple was destroyed by fire, so this lantern has the statue of the dragon to protect this temple from fire. Tips 提灯は高さ4m、直径3.4m、重さ670kg。松下幸之助は膝の痛みに悩まされていたが、浅草寺に参拝した結果治ったので、雷門再建のため寄付をしたそう。"
},
{
...
title: "マテリアル",
body: "マテリアル マテリアルとは マテリアルとは、ガイドをするための資料のことです。各観光地に何があり、どのようなことを説明したらよいのかを記載してあります。 各大学のESSが独自に製作しており、このマテリアルもそのうちの一つです。 2019年現在では東京外国語大学ESSや東京大学ESSの作ったマテリアルが主流なようです。 マテリアルの使い方 マテリアルには様々な知識が書いてあり、英文も記載しています。丸暗記しても良いのですが、会話の中で取り出す知識や言い回しを覚えておいて、会話の中で自然に取り出せるようになると良いでしょう。 マテリアルを見ながら説明するのは先方に失礼な他、ESSにガイドを許可してくださっている各ガイド地の方々の信頼を裏切ることとなります。ある程度の知識を頭に入れて、現地で思い出せなくなってしまった場合は班員を頼りましょう。 ガイドで大切なのは会話を楽しむことです。もちろん案内させていただく以上最低限の知識がないとまずいですが、第一の目的である、異国の地からはるばるやってきた方と会話を楽しむことを忘れないでください。"
},
{
url: "https://wress.github.io/guide-materials/asakusa/spots/nakamise/",
title: "仲見世",
body: "仲見世 仲見世 浅草寺境内の掃除の仕事を課せられていた近くの人に対し、境内や参道上に出店営業の特権が与えられ、出店していたことに由来する。現在、全部で88の店がここでお店を開いている。宝蔵門よりの店を役店と呼び、水茶屋が並ぶ。雷門よりには平店という、玩具、菓子、土産品を売る店が並ぶ。江戸初期以来300年近くの伝統を持つ店もある。 売り物に日本風のお菓子やお土産がたくさんあるので、それらも説明できると楽しいかもしれません。 例としては だるま 雷起こし 人形焼き 扇子 かんざし など……。 長い道なのでフリートークが重要になる場所でもあります！ This street is called Nakamise. About 88 stores are opened. There are many stores which deal with food, Japanese sweets, folk crafts, toys and various souvenirs. Some stores have been opened for more than 300 years."
},
{
...
title: "酒樽・ワイン樽",
body: "酒樽・ワイン樽 南参道には酒樽201本とワインの樽がある。これらは明治神宮に祀られている明治天皇への献上品である。 酒樽 酒樽は日本各地から送られたものである。樽にはお酒の名前が書いてある。 残念ながらこれらは展示用であり、すべて空である。 ちなみに日本酒を英語で\u0026rdquo;sake\u0026ldquo;という。発音記号は\u0026rdquo;sάːki\u0026rdquo; 基本的にキャッチしたらざっと自己紹介した後すぐにこれを説明することになるのでパッといえるように。 These are sake ballels. Have you ever drunk sake? Meiji Jingu enshrines Meiji Emperor. They are given to him by all over Japan. They are empty and just for display. Tips 酒樽に書いてある言葉がどんな意味なのか聞かれることも。大体は地名などなので、意味を理解してもらうのは難しい。わかりやすいものとしては真ん中下段のあたりに「富士」と書いた樽がある。Mt.Fujiは日本に旅行に来る外国人にもわかるはずなのでそれを説明すると楽しいかも。 ワイン樽 振り向くとそこにはワイン樽がある。これらはワイン好きだった明治天皇のためにフランスから寄贈されたものである。 明治天皇は明治維新を推し進めたことも察せる通り、西洋風のものを好んだ。明治神宮がワイン好きだったのもこれが由来。 フランスのワインなのでそれぞれフランスの地名が名前になっている様子。やっぱりどれも高級なワインらしい。 These are wine ballels. They are sent by France. Emperor Meiji liked European style meals and drinks, so these ballels are donated."
},
{
...
{
url: "https://wress.github.io/guide-materials/print/kokyo/",
title: "皇居東御苑 - 印刷用ページ",
body: "皇居東御苑 - 印刷用ページ"
},
{
...
title: "大番所",
body: "大番所 大番所 他の番所より格上で、最も位が高く強い武士がいた。 ただ、同心番所と百人番所が十分強かったために、ここまで敵が到達することはなかったと言われている。 The strongest guardiands guarded here. However, it is said that they don\u0026rsquo;t have to fight enemies because Dohshin-bansho and Hyakunin-bansho were strong enough."
},
{
...
title: "明治神宮御苑",
body: "明治神宮御苑 大鳥居を超えてしばらく進むと明治神宮御苑の入り口がある。入り口の前こそ通るが、中へは普段は入らず、素通りする。 もしガイドしている外国人の方に「行きたい」といわれたら、いつもは御苑内はガイドしていない旨を伝えたうえで、十分なガイドができないかもしれないがそれでも良いか尋ねること。 コースがかなり長く、入園するたびに500円かかるのであまりおススメしない。 清正の井戸や、隔雲亭といった歴史的な皇室にゆかりのある造形物が点在しており、更に花菖蒲や桜など季節の植物が綺麗な庭園である。ガイド後などに一度くらいは訪れても良いかも？ The gate is a entrance of Meiji Jingu Garden. It takes 500 yen to enter. We usually don\u0026rsquo;t guide in the garden."
},
{
url: "https://wress.github.io/guide-materials/print/asakusa/",
title: "浅草寺 - 印刷用ページ",
body: "浅草寺 - 印刷用ページ"
},
{
...
title: "キャッチ",
body: "キャッチ 外国人に声をかけることをキャッチといいます（あまり聞こえのいい言葉ではないですが……）。 慣れないうちは怖いかもしれませんが、その後の会話に入りやすいというメリットもあるので、積極的にキャッチしてみましょう！ キャッチのフレーズ まず、英語圏の方か確認しましょう。 Excuse me, do you speak English? Yesとかえってきたらまず、私たちの身分を明かし、目的を伝えましょう。 We are university students learning English. We would like to guide you in this (shirine / palace / temple) to improve our English skills and enjoy conversation with you. 無料であることを伝えるのも大切です。 Of course, it\u0026rsquo;s free of charge. 最後にもう一回確認しましょう。 Could we join you? 相手が承諾してくれたら、いよいよガイドスタートです！自己紹介をして、ガイドを始めましょう！ 急いでいたり、すでに何回かきたことがあると言って、ガイドを断る方ももちろんいます。そんな方には、「Have a good time :)」「Have a nice trip!」などと気持ちよく挨拶して別れましょう。 キャッチのポイント あまり急いでなさそうなゆっくり観光している方がオススメです。 年齢の若い方よりはお年を召された方の方がOKしてくれる傾向にあります。 仲の良さそうな若いカップル(手を繋いでいるなど)は遠慮したほうが良いかもしれません。 子どもづれも避けた方が良いです。子どもが飽きてしまうことがあります。 日本人がすでについているグループもやめておきましょう。"
},
{
...
title: "手水舎",
body: "手水舎 手水 手水は、神社やお寺に参拝する際、本殿に入る前に水で体を清める行為のことである。水場にひしゃくが置いてあり、決められた作法に従って手水を行う。 手水のやり方 ここは実演しながら説明できる場所なので、初心者でもだいぶやりやすいです！　ぜひ覚えてください！ ひしゃくで水をすくう。 ひしゃくを右手に持って、左手を洗う。 ひしゃくを左手に持ち替えて、右手を洗う。 ひしゃくを右手に持ち替えて、左手で水をすくい、口を漱ぐ。 左手をあらう。 ひしゃくの柄を洗う。 これを一杯の水で行う。 Over there, there is a main area of this shrine. We should purify our body there. There is a particular way to purify. I\u0026rsquo;ll show you. Please imitate me! Scoop the water. You mustn\u0026rsquo;t scoop twice! Wash your left hand. Wash your right hand. If you are OK, rinse your mouth.（嫌そうだったら強要する必要はありません） Wash your left hand again. Finally, wash the stick. Now you are purified! 口をゆすぐは、必ずrinse your mouthです！ 間違えても、wash your mouthとは言わないように！ wash your mouth は汚い言葉を使った小さい子をなだめる慣用句として使われているようなので。 Tips 手水は「ちょうず」と読むが手水舎は「てみずや」と読むので注意。"
},
{
url: "https://wress.github.io/guide-materials/asakusa/spots/main/",
title: "本堂",
body: "本堂 本堂 942年に元々の浅草寺は建立された。その後、関東大震災をも無事に免れ世間の話題となったが、 東京大空襲で「国宝浅草寺本堂」は焼け落ちてしまった。現在のものは1958年に建てられたものである。 戦争の歴史はタブーであることも多いので、下にある英語の内容だけ伝えられればバッチリです！ 外陣と内陣に分かれ、大扉の開いている昼間は内陣まで入れる。内陣中央にご本尊聖観世音菩薩像を安置する宮殿がある。三方扉となっていてそれは日本最大の大きさである。本尊は参拝することはできないが、本尊の前の間の「お前立ち」の本尊は33年ごとの開帳、慶祝や記念行事のときに臨時開帳が行われる。本堂では毎朝午前6時(夏)、6時30分(冬)に一日の行事が始まる。 Main Hall The original main hall seemed to be built in 942. But it was burnt many times. In 1958, today’s main hall was rebuilt. Inside the hall, beyond the curtain, the statue of the Goddess of Mercy called Kannon is placed, but we are not permitted to see it. 五円とご縁 お賽銭には五円玉を使うのが一般的で、理由は\u0026rdquo;五円\u0026rdquo;と\u0026rdquo;ご縁\u0026rdquo;が同じ発音だからである。本殿についたら五円玉を持っているか聞聞いてみると良い。 また、本来十円玉は\u0026rdquo;遠縁\u0026rdquo;となり縁起が悪いため、十円玉を使おうとしていたら教えてあげるのも良いかも。たくさん五円玉を集めておいて両替してあげるのが良いでしょう。 You can make a wish in front of the main building. Do you have a five yen coin? In Japanese, they are called goen and it is homonym. Goen also means good relationship. So they are the best coins to make a wish with, and we usually use the one. In contrast, a ten yen coin means bad relationship. You shouldn\u0026rsquo;t use the one. 注意 お寺では、参拝方法が神社と違い一礼のみです。もし一緒にやることになったら気をつけましょう。 また、宗教上の理由から参拝したくない外国人の方もいます。例えばイスラム教では偶像崇拝が禁止されており、ご本尊に手を合わせる行為は基本的にはやってはいけない行為です。 軽く上記の説明をした後、 You can make a wish here. Would you like to try it? と聞き、もし難色を示したら 速やかに出ましょう。 天井の絵 本堂の天井には天女と龍の絵が描かれています。気づきにくいので教えてあげると喜ばれる事が多い。これは本堂を建て直した際に描かれたもの。"
},
{
...
title: "本殿",
body: "本殿 本殿 1920年創建。第二次世界大戦中の1945（昭和20）年4月14日に空襲により焼失（このあたりはセンシティブなので触れなくても良い）。1958年に再建されて今に至る。 屋根は銅でできており、2018年の春頃に張り替えられた。そのため今は銅の茶色をしていますが、少し前までは緑青が生じ緑色の屋根だった。 本殿の中には平時は入れない。 ここでの参拝が終わったら集合写真を撮ることが多い。 That building is the main shrine. It was burned down during WWII. It is reconstracted in 1958. The roof is made from copper. It is reroofed in 2018. Now the roof is brown but it was green before 2018 because of oxidation of copper. 柱の傷 本殿の柱には傷がたくさんついています。これは昔、初詣の列に並んだ客が遠くからお賽銭を投げて、それが柱にもあたったときにできたもの。 よって、柱の裏側にはこの傷がほとんどない。 Those pillars have many scratches bacause many visitors threw coins on New Year\u0026rsquo;s Day. 注意 本殿の階段はたくさんの人が行きかうため、あまりここで立ち止まらないようにしましょう。 五円とご縁 お賽銭には五円玉を使うのが一般的で、理由は\u0026rdquo;五円\u0026rdquo;と\u0026rdquo;ご縁\u0026rdquo;が同じ発音だからである。本殿についたら五円玉を持っているか聞聞いてみると良い。 また、本来十円玉は\u0026rdquo;遠縁\u0026rdquo;となり縁起が悪いため、十円玉を使おうとしていたら教えてあげるのも良い。たくさん五円玉を集めておいて両替してあげるのも◎。 You can make a wish in front of the main building. Do you have a five yen coin? In Japanese, they are called goen and it is homonym. Goen also means good relationship. So they are the best coins to make a wish with, and we usually use the one. In contrast, a ten yen coin means bad relationship. You shouldn\u0026rsquo;t use the one. 二礼二拍手一礼 言わずと知れた神社の参拝方法だが、外国人にとっては異国のしきたりなので、実際に見せながら丁寧に説明しましょう。 お賽銭を投げる。 二回お辞儀をする。 手を二回たたく。 祈る。 もう一度お辞儀をする。 Throw a coin. Bow twice. Clap your hands twice. Make a wish. Finally, bow once again. 一応英語の説明書きもありますが、一緒に実演すると良いでしょう。 また、一応願い事は口外しない方が良いと言われているので、何を願ったかという話をするのはお勧めしません。 結婚式 時期にもよりますが明治神宮ではかなり高い頻度で結婚式が開かれている。ここでは神道の結婚式の一部である参進の儀を見ることができることがある。 日本式の結婚式ということで外国の方の注目を集めるポイント。もし結婚式の列を見たら日本の結婚式について説明できると良い。 参進の儀では2人の司祭と2人の巫女が一番最初に、続いて赤い傘の下に夫婦が、最後に家族と友人が列を作る。 日本の結婚式はほとんどキリスト教式の教会で行われていることや、ほとんどの日本人が無宗教なことも派生して説明できると面白いかも。 Look at that! This is a Shinto wedding ceremony! A typical procession is led by two priests and two shrine maidens, followed by the couple under a red umbrella, and finally family and friends. This style of wedding is not popular in Japan. We have weddings at churches even though we are not Christian. Most Japanese don\u0026rsquo;t follow a religion. We celebrate cristmas as Christian do and hold funerals as buddist do."
},
{
url: "https://wress.github.io/guide-materials/meiji-jingu/spots/couple-tree/",
title: "夫婦楠",
...
{
url: "https://wress.github.io/guide-materials/kokyo/spots/tea/",
title: "茶畑",
body: "茶畑 茶畑 日本中の茶畑の様子を再現した茶畑がある。意外と日本茶を植物としてみる機会はないので驚かれることも。秋には白い花が咲く。 This is the Japanese tea gurden. Tea gurdens like this can be seen across Japan. Those should have white flowers in autumn (fall). Tips 日本茶（緑茶）は意外と海外でも飲まれている。最近ではアイスクリームやチョコレートの抹茶フレーバーとしても親しまれている。今まで飲んだことがあるかや、好き嫌いを聞いてみても面白いだろう。"
},
{
...
title: "富士見多門",
body: "富士見多門 富士見多門 本丸広場の中腹あたりに富士見多門と呼ばれる建物がある。 少し奥まったところにあるのでわざわざ行かないことも多いが、たまには行ってみても面白いかも。 多門というのは長細い櫓の事で、石垣を上ってこようとする攻め手に窓から攻撃するための拠点となった。多門の下には蓮池濠が広がっており、水面から約19メートルの石垣の上にある。 「富士見」とついているのは昔ここから富士山が見えたことから。 This building is called the Fujimi-tamon Defence House. Through the narrow windows, they could shoot at enemies climbing the walls.It stands 19 meters above the surface of the pond. The word \u0026ldquo;Fujimi\u0026rdquo; means Mt.Fuji was visible from here, but it can nolonger be seen. Tips もっと手前のガイドコースを外れたところに「富士見櫓」という建物がある。名前は似ているが全くの別物なので注意。"
},
{
url: "https://wress.github.io/guide-materials/meiji-jingu/spots/votive-tablet/",
title: "絵馬",
body: "絵馬 絵馬 願いを書く木の板の事。書いた願いが叶うといわれている。外国語で書かれたものも多いので一緒に母語で書かれたものを探すと楽しい。 1つ500円で購入可。本殿を抜けてすぐ右手にある建物で変えます。 Ema is a votive tablet. It is believed that if we write our wish on the ema, they come true. You can buy the one at the store over there. It costs 500 yen. Tips 昔は本物の馬が奉納されていたが、馬を奉納できない人は木造の馬、それも出来ない人は木の板に馬の絵を書いたもので代用してよいとされていて、それが転じて次第に馬以外のものも増え、現在の絵馬になった。 明治神宮の絵馬には「菊紋と桐紋」が描かれたものと「その時の干支の動物」が描かれたものの二種類がある。数が多いのは前者。 干支は東アジア特有の文化だが案外欧米人にもよく知られている。Japanese Zodiacといえば通じるはず。 菊紋と桐紋に関する説明もできると楽しいかも。 祈願文 絵馬の前にあるテーブルで祈願文が書ける。願い事やお礼を書くのが一般的。紙に神様への文章を書いたのち、封筒にに自分で決めた額と紙を入れる。 You can write a letter to gods here. There are people who write wishes or gratitude toward gods. Usually, the letter is put into an envelope together with a monetary offering of any amount."
},
{
...
title: "授与所",
body: "授与所 授与所 本殿を抜けるとお守り・おみくじ・絵馬を売っている建物がある。この建物のことを授与所という。 This building is called Juyosho, a souvenir shop in shrines. You can buy amulets and fotune-teller here. お守り お守りが売っている。それぞれの願いに応じて一緒に選ぶと良い。 お守りの訳は色々あるが、「魔よけ」という意味のamuletがスッと伝わりやすい。 You can buy amulets here. There are charms for all kinds of occasions and purposes such as traffic safety, health, successful studies. 大御心 「おおみこころ」と読む。他の神社で見られる吉凶を占うおみくじではなく、祭神である明治天皇と昭憲皇太后様の作られた和歌の中から特に人倫道徳を指針とする教訓的なものを15首ずつ、合計30首選び、それに解説文を入れたもの。 一応明治神宮のおみくじであるが、和歌が書かれているだけで、「吉」「凶」などの運勢は直接的には書かれていない。 おみくじの説明に関しては浅草のおみくじの記事も参照のこと You can buy a fortune-telling paper here. The fortune-telling paper is different from other one. You cannot know whether you are lucky or unlucky but get a message form Meiji Emperor. 大御心は英語版があるので、そっちを引いてもらうのがベター。 日本語版は和歌なので、古文の解釈もできて、かつ英語で訳さなければならない。 逐語訳をするだけでは、意味が全く伝わらない。 ただ、「挑戦してみたい！」という方は挑戦してみる価値はあるかもしれない！"
},
{
url: "https://wress.github.io/guide-materials/kokyo/spots/stone-cellar/",
title: "石室",
body: "石室 石室 「いしむろ」と読む。 火事やその他の緊急時に大事なものが延焼しないように運びこんだらしい。 なお、中には入れません。（もし入ったら、皇居警察が飛んで来ます） This is called Ishimuro. It means stone-cellar. People carried furniture and books here in cases of emergency."
},
{
...
title: "カスケード原宿",
body: "カスケード原宿 ジャニショの少し奥にある建物で、ご飯屋さんがたくさん入っています。迷ったらとりあえずここに来てみて班員さんが行きたいお店を選ぶのも手です。 カスケード原宿の公式サイトはこちら スポンティーニ 有名なピザ屋さん。厚いピザをフォークとナイフで食べる。結構お腹いっぱいになります。 公式サイトはこちら KINTAN 少し高いけど焼肉が食べられる。行くかどうかは班員の財布と要相談だが間違いなくおいしくてお勧め。 他にもたくさんお店があります。一覧はカスケード原宿の公式サイトを参照してください。"
},
{
...
title: "丸の内パレスビル",
body: "丸の内パレスビル 大手門正面の交差点を渡ってすぐのビル 東京純豆腐 スンドゥブ(韓国のスープ)のお店。 スパイス無しも選べるので、辛いのが苦手な人がいても大丈夫です。あったかいので、冬の寒い日にはぴったりです。1000円ぐらいで食べられます。 がっつりとは言えないかも\u0026hellip;?? https://tokyo-sundubu.net 蕎麦と酒 いなたや お蕎麦の種類たくさんで、細麺・太麺も選べます。 一度ガイドした外国人を連れて行ったら喜んでもらえたことも。 お酒は飲まないように気をつけて。 https://www.google.co.jp/amp/s/s.tabelog.com/tokyo/A1302/A130201/13140960/top_amp/ ドトール 最後時間を潰すならここ。 皇居の周りはお店が少なく、ここが一番近いです。 セブンイレブン これもビルの地下一階にあります。 中途半端に時間が余ってしまった時は、春とかであれば、ここでスイーツでも買っていつもの集合場所で食べて待つというのもお財布に優しくてよかったです。"
},
{
url: "https://wress.github.io/guide-materials/kokyo/food/eiraku/",
title: "丸の内永楽ビルディング",
body: "丸の内永楽ビルディング 大手門正面の交差点から１区画ほど歩いたところにあるビル おでん　かしみん 鶏肉料理がメインの各定食におでんがついてきます。 1000円程度でありながら、かなりお腹いっぱいになれます。 https://tabelog.com/tokyo/A1302/A130201/13136068/dtlmenu/lunch/ 88屋 日曜日は閉まってるから、開店してる時に行ったあなたは土曜日に行ったということであります。四国料理が食べられます。 鯛めしもあります。 当たり前だけど、土曜日ガイドの時しか行けないお店です。 https://tabelog.com/en/tokyo/A1302/A130201/13136028/ 大かまど飯　寅福 和食のお店。 定食が1000円ちょいでがっつり食べられます。ここも美味しかったです。 https://www.google.co.jp/amp/s/s.tabelog.com/tokyo/A1302/A130201/13136065/top_amp/ 舎鈴 ラーメン、つけ麺屋さん。 金欠の班員がいらっしゃったら行きましょう。 https://www.google.co.jp/amp/s/s.tabelog.com/tokyo/A1302/A130201/13136013/top_amp/"
},
{
...
title: "明治神宮について",
body: "明治神宮について 歴史 明治神宮は1920年（大正9年）に創建された神社。日本の近代化を主導した明治天皇と昭憲皇太后が祀られている。明治神宮が出来る前は皇室の所有地だったが、畑がほとんどで、荒れ地のような景観が続いていたそう。 創建の際に全国から植樹する木を奉納したいと献木が集まり、全部で約10万本の木が奉献されたそう。 Meiji Jingu Shrine was built in 1920 to enshrine Emperor Meiji and his wife. In those days, there were nothing but farm around here, but when the shrine was established, people from all parts of Japan donated many trees. Now, they have grown to a big forest. 所要時間 基本的には30~40分くらいで一周できる。場合によっては1時間以上かかることも。キャッチ時間は10分くらい。一回のガイドで2～3組くらいが目安。 ガイドスタイル 皇居ほどフリートークの比重は大きくなく、浅草ほどキャッチの成功率も低くなく、初心者にはうってつけのガイド地。ただ砂利道で少し歩きにくいかもしれないので靴には気を付けたほうが良い。道が広くてガイドしやすいのも特徴。 また境内は飲食禁止なので、食べ歩きから帰ってくるときは食べ物は持ち込まないように注意。 アクセス JR原宿駅表参道口・東京メトロ明治神宮前駅2番口→徒歩1分で南参道口 JR代々木駅西口・都営地下鉄代々木駅A1出口→徒歩5分で北参道口 小田急電鉄参宮橋駅→徒歩3分で西参道口 集合場所 南参道鳥居（一の鳥居）前集合。JR原宿駅・東京メトロ明治神宮前駅から明治神宮に向かって一つ目の鳥居。"
},
{
...
title: "花みずき",
body: "花みずき お蕎麦屋さん。夜は居酒屋らしい。 予算は600円~1000円でリーズナブル。内装は古風で歴史を感じる。 食べログも参照してみてください！ https://tabelog.com/tokyo/A1311/A131102/13037106/"
},
{

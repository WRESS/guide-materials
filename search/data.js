...
title: "大草履",
body: "大草履 \r\r大草履 仁王像制作者である村岡久作氏の出身地と言うご縁で山県村山市楯岡の有志らが村から奉納したもの。浅草寺は、その信者も多くおり、彼らもそのうちの何人かである。浅草寺にはこんな大きなわらじをはく人がいるならと驚いて魔が去っていくという、魔除けと健脚を願い「わらじ」に触れていく人もいるそう。左右一対になっている。 Big Straw Sandals On the back side of Hozo-mon Gate, we can see a pair of big straw sandals. They were donated from the village in Yamagata Prefecture (in the north area of Japan) as believers of Senso-ji Temple. People believed that evil spirits would escape from the temple when they saw the big sandals thinking that God in Asakusa is so big. \r"
},
{
...
title: "桝形",
body: "桝形 桝形 \r\r桝形とはいわゆる直角の曲がり角である。ここでは明治神宮御苑の入り口をすぎて奥にある角を指す。大きな看板が目に付く曲がり角である。 ここの看板には明治天皇が書かれた俳句や五箇条の御誓文などが掲示されており，定期的に（毎年？）変わる。訳すのは困難なので，場合によってはその旨を伝えた方が良い。 実はこの曲がり角，90度ではなく88度である。 \r\r\r\r\rA poem written by Meiji Emperor is written on the sign. This corner is not square, actually 88 degrees. Because 8 is a good number in Japan. \rTips 説明するまでもないと思うが，末広がりの八なので88度なのである。詳しく説明するためには漢数字の八の形を示して，下側が広がっていることを言えばいい。が，手水舎がすぐそこにあるのでそこまで説明している余裕はないかも。"
},
{
...
title: "記事の追加（その２）",
body: "記事の追加（その２） 基本的なMarkdown記法 ここでは基本的なMarkdown記法を解説します。ここで紹介するもので基本的には事足りると思いますが，ほかにもMarkdown記法はあり，そのほとんどがこのサイトでも使えるので，各自調べてみてください。 また，このサイトでは独自に画像の追加などの機能を拡張しています。それに関しては記事の追加（その４）で解説します。 改行 段落の変更は行を一つあけることによってできます。 記述例 これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。 段落が変わりました。これが二つ目の段落です。 \r表示例 　これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。これは一つ目の段落です。 　段落が変わりました。これが二つ目の段落です。 \rこのように，段階が変わると行頭の文字が一字下がります。基本的に改行はこの方法で行ってください。 行を一行空けないただの改行は，Markdownからは無視されます。 記述例 改行が無視されます。 改行したけど無視されてます。 \r表示例 改行が無視されます。 改行したけど無視されてます。 \rまた，改行にはもう一つ方法があります。「\\\\」を使う方法です。 記述例 改行します。\\\\ 改行しました。 \r表示例 改行します。 改行しました。 \rこちらは一行空けと違い，段落は変わりませんので，行頭一字が下がりません。 強調 文字を太字にできます。 記述例 そんなことは**しないで**ください \r表示例 そんなことはしないでください \r見出し 見出しは文字が大きくなります。↑の見出しの文字が見出しです。見出しを書くには#を使います。 記述例 ## 見出し2 ### 見出し3 \r表示例 見出し２ 見出し3 \r#は必ず半角で記述してください。また，#と文字との間に一つ半角スペースを入れるのを忘れないでください。 見出し１として#を一つ使うという記法もMarkdownにありますが，このサイトでは見出し１をタイトルの表示に使っています。 \r\rこの赤丸で囲った部分が見出し１です。この部分は自動で追加されるため，自分で書くと二重になってしまいます。そのため，#を一つ使う見出し１は使わず，見出し２，３と使い続けていってください。 また，見出し２，３は順番に使ってください。 悪い例 ## 果物について 果物について紹介していくよ ## みかんについて オレンジ色の果物だよ ## ぶどうについて 紫色の果物だよ \rこの例では「みかん」「ぶどう」のセクションに「果物」と同じ見出し２を使っているため，構造的におかしいです。文章の構造的には「果物」についての紹介の中に「みかん」「ぶどう」についての紹介があるはずなので，次のように訂正できます。 良い例 ## 果物について 果物について紹介していくよ ### みかんについて オレンジ色の果物だよ ### ぶどうについて 紫色の果物だよ \r箇条書きリスト 箇条書きリストは次のようなものです. 表示例 一つ目の箇条書き項目 二つ目 三つ目 \r書き方はとてもシンプルです。 記述例 * 一つ目の箇条書き項目 * 二つ目 * 三つ目 \r「*」の他に「-」や「+」でも書けます。「・」では書けません（全角なのでパーサが対応してない）。また，見出しと同じように，各文字は半角で，文字と「*」の間には半角スペースを入れるのを忘れないでください。 番号付きリスト 順序があるものの列挙にはこちらを使ってください。 記述例 1. まず～ 1. 次に～ 1. 最後に～ \r表示例 まず～ 次に～ 最後に～ \r数字には「1」を使いましたが，この数字は何でもOKです。とにかく「（数字）. 」と入力することで，順番通りに数字が割り当てられます。普通に1,2,3と割り振っても大丈夫です。 記述例（別解，表示は同じ） 1. まず～ 2. 次に～ 3. 最後に～ \r"
},
{
url: "https://wress.github.io/guide-materials/meiji-jingu/spots/votive-tablet/",
title: "絵馬",
body: "絵馬 \r\r絵馬 昔は本物の馬を神社に奉納していた。その名残で馬の絵が書かれている。干支の動物(the twelve zodiac signs)が描かれたものも多い。願い事を書くと叶うと信じられている。外国語で書かれたものも多いので一緒に探すと楽しい。 1つ500円で購入可。 “E” means a picture and “ma” means a horse in Japanese. In the old days, people would offer real horses to the shrine. So now pictures of horses are drawn on the tablets. The name of “Ema” is derived from this. It is believed that if you write your wish, the wish will come true. \r"
},
{
url: "https://wress.github.io/guide-materials/info/adding3/",
title: "記事の追加（その３）",
body: "記事の追加（その３） このページでは，実際にどのようにページを追加するかを解説します。 フォルダの構造 基本的には「WRESS2019ルートフォルダ/Guide/新マテリアル/guide-materials」内のcontentフォルダを編集します。逆に「WRESS2019ルートフォルダ/Guide/新マテリアル/guide-materials」内のcontentフォルダ以外には触らないでください。 各ガイド地のガイドスポットと，食事スポットの記事がここから追加・編集できます。 Markdownで書いた記事のファイル名 WRESS2019ルートフォルダ/Guide/新マテリアル/guide-materials/content/meiji-jingu/spots/first-tori/index.md WebサイトでのURLhttps://wress.github.io/guide-materials/meiji-jingu/spots/first-tori/ \rspotsフォルダにはガイドスポットの，foodフォルダには食事スポットの記事が入っています。 記事の編集 ここでは大鳥居の例を示します。 大鳥居は明治神宮のガイドスポットですから，「WRESS2019ルートフォルダ/Guide/新マテリアル/guide-materials/content/spots/meiji-jingu/spots/first-tori/」を参照します。ここには「index.md」というファイルがあるはずです。これを編集した後，WRESSガイドセクションの人に声をかけてください。タイミングによりますが，確認後すぐに記事が反映されると思います。 記事の追加 例えば明治神宮の食事スポット「ブルーガーデン」を追加してみましょう。明治神宮の食事スポットですから，「WRESS2019ルートフォルダ/Guide/新マテリアル/guide-materials/content/spots/meiji-jingu/food/」を参照します。この下に，フォルダを作ってください。フォルダ名はURLの一部になります。例えばここで「blue-garden」という名前を付ければ，「https://wress.github.io/guide-materials/meiji-jingu/food/blue-garden/」というURLになります。 この中に，「index.md」というファイルを作り，これを編集してください。 簡単に言えば，ここでいうblue-gardenフォルダ内でページに関するものを作っていく形になります。次の項で紹介する画像を追加する際もこのフォルダを利用します。また，常にMarkdownファイルのファイル名は「index.md」としてください。 記事のフロントマター 前述のMarkdown形式で文章を書いていくのですが，index.mdの最初にフロントマターと呼ばれるパーツを組み込む必要があります。フロントマターは次のように記述します。 --- title: \u0026quot;《記事のタイトルをここに書く》\u0026quot; weight: 《記事の順番の指定》 necessity: 《必要度の指定》 image: \u0026quot;《一覧に表示する画像の指定》\u0026quot; author: \u0026quot;《著者の名前》\u0026quot; --- \r---でくくるのを忘れないでください。 以降はフロントマター内の各項目について解説します。 title titleは記事のタイトルになります。各記事の一番上の中央に出てくるのがこれです。\u0026quot;\u0026quot;でくくるのを忘れないでください。 title: \u0026quot;記事のタイトル\u0026quot; \rweight weightは，一覧のページ（ex: ガイドスポット\r\r）で順番を決めるのに重要になる数字です。任意の有理数（少数表記）で指定し，数字が小さいほど前に，大きいほど後ろに並びます。主に記事をガイドする順に並べるためにこの数字を使っています。 weight: 3 \rnecessity necessityはspotsフォルダ内の記事に必要です。必要度の指定をしており，これがそのまま☆の数になります。1,2,3のいずれかの数字を指定してください。 なお，spotsフォルダ内の記事にこの値を指定し忘れたり，無効な値が設定されていると 重要度：未設定 と表示され，一覧ページ\r\rでチェックボックスの有無にかかわらず常に表示されるようになってしまいます。ガイドスポットの記事を書く際には必ず指定してください。 逆に，foodフォルダ内の記事には不要です。指定しても☆は出ません。 necessity: 3 \rimage imageは，一覧のページに表示する際，カードの上部に表示する画像の指定になります。 \r\rこれを書かなかった場合は基本情報ページのように記事の一部を抜粋した文章が代わりに入ります。 \r\rimageを追加する方法を説明します。 まずは記事のフォルダ（index.mdが入っているフォルダ）を開きます。この南参道鳥居であれば，「WRESS2019ルートフォルダ/Guide/新マテリアル/guide-materials/meiji-jingu/spots/first-tori/」というフォルダです。この中に画像ファイルを入れます。 画像ファイルの名前は何でも良いですが，短くてわかりやすい名前が良いと思います。基本的には全角文字は使わないでください。 すると次の画像のようになるはずです。 \r\rこの状態で，フロントマターに次のように画像のファイル名をそのまま記述します。 image: \u0026quot;first-tori.jpg\u0026quot; \rこれでこの画像が一覧ページで表示されるようになります。「\u0026quot;\u0026quot;」でくくるのを忘れないでください。 author authorには著者の名前を記入してください。これは誰が編集したかを管理するために使う値で，実際のWebサイトには表示されません。 記事の例 大鳥居の例を示します。 --- title: \u0026quot;大鳥居\u0026quot; weight: 4 image: \u0026quot;meji-jingu.jpg\u0026quot; necessity: 3 --- 日本一大きいヒノキ製の木造鳥居であり、高さ12m、柱間9.1m、柱の径1.2m、重さ13tもある。実はこの鳥居は二代目であり、初代は昭和41年(1966)に落雷のため破損してしまい、現在は昭和50年(1975)12月に新しくできたものである。鳥居の上の方には皇室のご紋である十六葉八重表菊がついている。 ## 鳥居の三つの役割 1. 神社の神域と私たちの世界との境界を示すもの 2. 邪悪なものを入れないようにする結界 3. 私たちの身を清めるため。 \r各フロントマターとMarkdown記法で書いた内容は次のように変換されます。 \r\r"
},
{
...
title: "モンブラン",
body: "モンブラン \r\r\r有名人のサインがいっぱいある(ので、私は有名だと思ってる)ハンバーグやさん。がっつり洋食の割には、1000円前後で食べられ、しかも美味しい。いつも店の外まで待っている人が居るが、以外と回転が早く、見た目ほど待たない。　食べログも参照してみてください！ https://tabelog.com/tokyo/A1311/A131102/13009804/"
},
{

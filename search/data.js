...
title: "天皇制",
body: "天皇制 皇族に関する豆知識 元号も変わり、皇族や天皇制についての質問が増えることが予想されます。ガイドの前にさらっと確認してみてください! よく使う用語 天皇家：Imperial Family 天皇　：Emperor 皇后　：Empress 皇太子：Crown Prince 上皇　：Grand Emperor (by BBC) 宮内庁：Imperial Household Agency 王座　：the throne 公務　：official duty, public activity 退位する：abdicate, leave the throne 即位する：enthrone, take (assume) the throne ちなみに、イギリスの皇太子はThe Prince of Walesという独特の呼ばれ方をするそう。イギリスの方には、この表現の方がピンとくるかもしれない。 また、現在の天皇のことを今上(きんじょう)天皇と呼ぶ。 日本の象徴 日本国憲法 第一条 天皇は、日本国の象徴であり日本国民統合の象徴であつて、この地位は、主権の存する日本国民の総意に基く。 とあるが、このまま説明するとわかりにくいので以下の表現でよいでしょう。 After the World War II, the emperor became the symbol of Japan under the new constitution. 天皇の仕事 皇室の歴史 皇室の歴史は伝説から始まっているが、実存が確認できている天皇から数えてもすでに1500年以上も続いており、天照大神から始まっている。 歴史上、形式的な存在だった時期も長かったが、明治から終戦までは現人神として不可侵の存在とされていた。 現在は政治的権力のない象徴的存在とされている。 It is said that unbroken line of descent from the Great Sun Goddess continues to today from some thousands years ago. Japanese imperial family is the oldest royal family in the world. Emperors had been figureheads for a long time over the course of history. Then, the emperor was considered as inviolable living god during the period between the beginning of the 19th century and end of the war in 1945. After the World War II, the emperor became the symbol of Japan without any political power. 歴代の天皇 お名前を聞かれることも多いです。少なくとも、今上天皇と上皇陛下の名前は覚えておくとよいでしょう。 明治天皇：睦仁(むつひと)さま 大正天皇：嘉仁(よしひと)さま 昭和天皇：裕仁(ひろひと)さま 上皇陛下：明仁(あきひと)さま 今上天皇：徳仁(なるひと)さま 在位期間がもっとも長い天皇は昭和天皇で62年2週間となっている。 明仁上皇の在位期間は30年であった。なお、徳仁天皇は第126代天皇である。 また、今回の皇位継承により、皇位継承権第1位は徳仁天皇の弟である秋篠宮家の文仁さま、第2位はそのご子孫の悠仁さまとなっている。 Naruhito\u0026rsquo;s brother Prince Fumihito will be next in line to the throne, followed by the new emperor\u0026rsquo;s nephew, 12-year-old Prince Hisahito. New emperor has a daughter, Princess Aiko, who was born in 2001. However, Japanese law prohibits women from inheriting the throne. 皇位継承 生前退位が行われたのは、202年ぶり。君主が存命の間に、その地位を後継者に引き渡す行為は譲位とも呼ばれ、こちらの方が昔から使われている。これまでにに50回以上行われている。 Emperor Akihito left (abdicated) the throne on April 30, and his son, Crown Prince Naruhito took (assumed) the throne on May 1. Emperor Akihito left the throne while he is alive for the first time in 202 years. 元号 みんなご存知の通り、天皇が変わるタイミングで日本の元号は変わります。 The era in Japan corresponds to the reign of each emperor. It means that when an emperor leaves the throne and the following emperor takes the throne, the era in Japan changes into next one."
},
{
